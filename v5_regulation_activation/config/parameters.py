...
class Strategy(str, Enum):
    ...
    RULE_BASED:  Price-sorted schedule, no optimization, no regulation.
    EMS_CLAMPS:  EMS hourly re-solve + hard SOC clamps, open-loop regulation.
    EMS_PI:      EMS + PI regulation tracking, no MPC trajectory management.
    FULL:        EMS + MPC + PI — complete hierarchy.
    """
