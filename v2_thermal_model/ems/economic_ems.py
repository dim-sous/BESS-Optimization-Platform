...
v2_thermal_model: 3-state (SOC, SOH, Temperature) dynamics with
...
from config.parameters import BatteryParams, EMSParams, ThermalParams, TimeParams
...
class EconomicEMS:
    ...
    def __init__(
        ...
        self._F_ems = build_casadi_rk4_integrator(bp, thp, tp.dt_ems)
