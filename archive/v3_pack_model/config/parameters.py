...
v3_pack_model: adds PackParams for multi-cell pack with active balancing.
Inherits all v2_thermal_model parameters unchanged.
...
@dataclass(frozen=True)
class PackParams:
    """Multi-cell battery pack configuration for v3_pack_model.
    ...
    Zero-sum enforced across all cells for energy conservation.
    """
