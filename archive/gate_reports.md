# Gate Reports — Historical Archive

This file holds the four-stage gate review reports for v1–v5. These are
preserved as audit trail / engineering history. They describe the system as
it was at each version's freeze point and **should not be cited as
physically-correct numbers** in any external context — see the
[v5 audit findings](../backlog.md) (item 0) for the bugs that affect them.

> v1–v4 are frozen in [archive/](.) and were never repaired.
> v5 was the active development version when these audits surfaced.
